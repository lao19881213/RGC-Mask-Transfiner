...
if __name__ == '__main__':
    ...
    train_file = '%s/training_set/TrainingSet_B5_v2_ML.txt' % SDC1_HOME
    train_csv = '%s/training_set/TrainingSet_B5_v2_ML.csv' % SDC1_HOME
    whole_field = '%s/SKAMid_B5_1000h_v3.fits' % SDC1_HOME
    train_field = '%s/SKAMid_B5_1000h_v3_train_image.fits' % SDC1_HOME
