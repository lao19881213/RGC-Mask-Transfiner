...
def split_file(fname, width_ratio, height_ratio, halo_ratio=50,
    ...
    for i, x in enumerate(nx):
        for j, y in enumerate(ny):
            ...
            os.system(splitimg_cmd % (fname, out_fname, x1, y1, (x2 - x1), (y2 - y1)))
            if (show_split_scheme):
...
if __name__ == '__main__':
    ...
    fname = args.fname #'/o9000/MWA/GLEAM/data_challenge1/SKAMid_B1_1000h_v3.fits'
    workdir = args.workdir #'/o9000/MWA/GLEAM/data_challenge1/split_B1_1000h'
    split_file(fname, 26, 24, show_split_scheme=True,  #image size 132; ratio 32768/132,new:3496 3203 
