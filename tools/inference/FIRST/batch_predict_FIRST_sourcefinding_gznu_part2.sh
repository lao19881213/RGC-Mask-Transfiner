...
CUDA_VISIBLE_DEVICES=2 python3 demo/batch_predict.py --config-file configs/transfiner/mask_rcnn_R_101_FPN_3x_deform_infer.yaml \
  --input '/home/data0/lbq/inference_data/FIRST_fits' \
  --pnglists '/home/data0/lbq/inference_data/FIRST_final_png_part2.txt' \
  --rmsdir /home/data0/lbq/inference_data/FIRST_rms \
  --mirdir FIRST_mir \
  --output '/home/data0/lbq/inference_data/FIRST_pred' \
  --confidence-threshold 0.5 \
  --catalogfn FIRST_infer_part2 \
