...
result_file = '/home/data0/lbq/RGC-Mask-Transfiner/FIRST_results/RPA_test.csv'
...
#       RPA_all.append('--') 
#   
#   hetu_csv_1['RPA_comp'] = RPA_all
#   hetu_csv_1.to_csv('/home/data0/lbq/RGC-Mask-Transfiner/FIRST_results/FIRST_HeTu_paper_fr2_flux_fixed_RPA_comp.csv', index = False)

for n in range(len(ra)):
    with open('/home/data0/lbq/RGC-Mask-Transfiner/FIRST_results/RPA.txt', 'r') as file:
    ...
    if (n+1) > linecount:
       ...
       if RPA < 0:
          RPA += 180.
       with open('/home/data0/lbq/RGC-Mask-Transfiner/FIRST_results/RPA.txt', 'a') as f:
            f.write('%d,%f\n' % (n, RPA))
