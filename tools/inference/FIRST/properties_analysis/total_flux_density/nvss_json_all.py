...
NVSS_dir = '/home/data0/lbq/RGC-Mask-Transfiner/tools/inference/FIRST/properties_analysis/FRII/NVSS4flux_final_all'

NVSS_fits_dir = '/home/data0/lbq/RGC-Mask-Transfiner/tools/inference/FIRST/properties_analysis/FRII/NVSS'
...
for m in range(len(fitsfs)):
      ...
      NVSS_fits = '%s/FRII/NVSS/NVSS_%s.fits' % (root_dir, source_name)
      try:
