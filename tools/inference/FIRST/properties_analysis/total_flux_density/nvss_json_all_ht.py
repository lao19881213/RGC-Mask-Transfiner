...
NVSS_dir = '/home/data0/lbq/RGC-Mask-Transfiner/tools/inference/FIRST/properties_analysis/HT/NVSS4flux_final_all'
...
hetu_csv = pd.read_csv('/home/data0/lbq/RGC-Mask-Transfiner/FIRST_results/FIRST_HeTu_paper_ht.csv')
...
for m in range(len(fitsfs)):
      ...
      FIRST_fits = '%s/HT/FIRST/%s.fits' % (root_dir, source_name)
      ...
      NVSS_fits = '%s/HT/NVSS/NVSS_%s.fits' % (root_dir, source_name)
      try:
