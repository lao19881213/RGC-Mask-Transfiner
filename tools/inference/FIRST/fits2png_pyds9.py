...
parser.add_argument('--catalog_file', dest='catalog_file', type=str, default='HT.txt', help='catalog file')

args = parser.parse_args()

catalog_file = args.catalog_file

data_dir = "/p9550/MWA/GLEAM/blao/hetu_images/deep_learn/v3_mask_results" #os.path.join(cur_dir, '..', 'data')
fits_dir = osp.join(data_dir, 'HT')
png_dir = osp.join(data_dir, 'HT')
