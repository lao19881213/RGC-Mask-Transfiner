...
Mingo_csv = pandas.read_csv("/p9550/LOFAR/LoTSS-DR1/Mingo19_LoMorph_Cat_v2_re.csv")
    ...
    with open('lofar_image_range.txt') as f:
         for line in f:
             ...
             if RA[i] > RA_min and RA[i] < RA_max and DEC[i] > DEC_min and DEC[i] < DEC_max:
                ...
                cutout_cmd = '/home/software/wcstools-3.9.6/bin/getfits -o %s -d %s %s %d %d %d %d' % (filename_fits, dst_path, os.path.join(input_dir, fn), source_x, source_y, 50,50)
