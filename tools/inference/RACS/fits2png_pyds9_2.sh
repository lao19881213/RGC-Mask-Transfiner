...
#IMGS="0037-06A"
IMG_FILES="/home/data0/lbq/inference_data/ASKAP_RACS/RACS_mid/part1_fits_fixed_2.txt"
...
do
    ...
    python fits2png_pyds9_2.py --inpdir ${IMG_DIR}/${SBID}_split_fits_png --outdir ${IMG_DIR}/${SBID}_split_fits_png 
    #done
done
