...
if __name__ == '__main__':
    # TO-DO-BELOW
    aug_times = 50
    in_dir = "/p9550/MWA/GLEAM/blao/hetu_images/deep_learn/training_sets/v3_mask/train_final"
    out_dir = "/p9550/MWA/GLEAM/blao/hetu_images/deep_learn/training_sets/v3_mask/train_final_aug"
    #---check-------------
    mkdir(out_dir)
