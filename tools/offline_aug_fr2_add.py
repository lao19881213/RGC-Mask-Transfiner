...
if __name__ == '__main__':
    # TO-DO-BELOW
    aug_times = 200
    in_dir = "/p9550/MWA/GLEAM/blao/hetu_images/deep_learn/training_sets/v3_mask/fr2_add_2_anno"
    out_dir = "/p9550/MWA/GLEAM/blao/hetu_images/deep_learn/training_sets/v3_mask/fr2_add_2_aug"
    #---check-------------
    mkdir(out_dir)
